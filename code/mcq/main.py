...
def main():
    ...
    def compute_metrics(eval_predictions):
        ...
        np.save(training_args.output_dir + '/predictions.npy', predictions)
        np.save('label_ids.npy', label_ids)
        np.save(training_args.output_dir + '/label_ids.npy', label_ids)
    ...
    if training_args.do_train:
        ...
        result = trainer.evaluate(tokenized_datasets["train"])
        logger.info("***** Evaluate Train Results *****")
    ...
    label_pred = pred_results.predictions.argmin(axis=1)
    np.save('replace_index.npy', label_pred)
