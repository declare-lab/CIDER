...
if __name__ == '__main__':
    ...
    # save_dir    = 'outputs/' + model_id[model] + '/fold' + fold + '/' # train.py and predict.py same dir should be the same
    save_dir    = 'adversarial-outputs/' + model_id[model] + '/'
   
    # train_file = '/home/emrys/Data/csk_data/csk_qa_22_01/data/qa/adversarial_train_and_test.json'
    train_file = 'original_data/relations_only/train_and_test.json'
    x_train = x_test = json.load(open(train_file))
